	...
	if (msg->arrivedOn("in")) {
	    {
	        ...
	        simtime_t frame_age = ethOutGate->getTransmissionFinishTime() - msg->getTimestamp();
	        ...
	        scheduleAt(ethOutGate->getTransmissionFinishTime() + IFG_TIME, endServiceMsg);
